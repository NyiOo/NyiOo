...
try:
  ...
  from PyQt4.QtGui import QWidget,QColor,QImage,QPainter,QFont
  ...
  def eventFilter(self, object, evt):
    ...
    if self.mp != None:
      ...
      if t == QEvent.MouseButtonDblClick:
        ...
        self.main.frequency_spinbox.setValue(f/1e6)
        self.main.freq_changed(f)
